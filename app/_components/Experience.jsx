...
export const socials = [
    {
        ...
        link: "https://www.facebook.com/abdalmoamn.abara",
    },
    {
        icon: <FaGithub className="text-lg" />,
        link: "https://github.com/abodico",
    },
    {
        icon: <FaInstagram className="text-lg" />,
        link: "https://www.instagram.com/abdalmoamn.abbara/",
    },
    {
        icon: <FaLinkedin className="text-lg" />,
        link: "https://www.linkedin.com/in/abdalmoamen-abbara/",
    },
    {
        icon: <FaGitlab className="text-lg" />,
        link: "https://gitlab.com/abomajedabbara8",
    },
]
const Experience = () => {
    return (
